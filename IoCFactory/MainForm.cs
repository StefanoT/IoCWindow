...
using IoCFactory.Log;
using IoCFactory.Container;
using IoCFactory.Factory;
...
namespace IoCFactory
{
    public partial class MainForm : Form
    {
        ...
        private IChildFormFactory ChildFormFactory;

        public MainForm(ILogger _Logger, IChildFormFactory _ChildFormFactory)
        {
            InitializeComponent();

            Logger = _Logger;
            ChildFormFactory = _ChildFormFactory;
        ...
        private void openButton_Click(object sender, EventArgs e)
        {
            ...
            ChildForm newChildForm = ChildFormFactory.Create();
            newChildForm.Closed += delegate
            {
                Logger.Info("Closed child window");
                ChildFormFactory.Release(newChildForm);               
            };
            newChildForm.Show();
